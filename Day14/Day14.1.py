...
class instructiongroup:
	...
	def execute(self):
		#returns a dict. memory address : data
		#bitwise function: mM + 'MMI or (M(m+`MI))
		tempmems = {addr: (self.mask & (self.maskmask | ((~self.maskmask)&data))) for addr, data in self.instrlist}
		return tempmems
